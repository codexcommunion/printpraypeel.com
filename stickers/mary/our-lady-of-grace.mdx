...
downloadFormats:
  ...
  - pdf:
      path: "./8count-2.5in-wide_clear_halo.pdf"
      printReady: true
      paperSize: "US Letter (8.5x11)"
      layout: "8 stickers per sheet"
      label: "Print Ready - Clear Halo"
  - pdf_colorized:
      path: "./8count-2.5in-wide-colorized.pdf"
      printReady: true
      paperSize: "US Letter (8.5x11)"
      layout: "8 stickers per sheet"
      label: "Print Ready - Colorized"
